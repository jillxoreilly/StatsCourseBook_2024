...
There is always a tradeoff between controlling the level of false positives and false negatives. This is because we as scientists set the criterion for statistical significance. If we set a stringent criterion, there will be fewer false positives but more false negatives.
